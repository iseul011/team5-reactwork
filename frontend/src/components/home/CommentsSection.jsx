...
function CommentsSection() {
  ...
  const navigate = useNavigate();  // useNavigate 훅을 사용하여 경로 이동을 처리
  ...
  return (
    <div className="comments-section">
      ...
      <div className="comments-actions">
        {/* 쪽지 보내기 버튼 */}
        <button className="letter-button" onClick={() => navigate('/write')}>쪽지 보내기</button>
        {/* 쪽지함 버튼 */}
        <button className="letter-button" onClick={() => navigate('/inbox')}>쪽지함</button>
